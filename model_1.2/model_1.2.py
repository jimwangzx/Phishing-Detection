...
for header in ['Length', 'CommonWords', 'Slashes', 'DoubleSlash', 'QuestionMark', 'AtSymbol', 'PeriodCount', 'Dash', 'Semicolon', 'WLetter', 'VLetter', 'XLetter', 'ZLetter', 'JLetter', 'QLetter', 'Vowels', 'DotService']:
