...
# Read Dataset
data = pd.read_csv(r"C:\Users\cbyle\Desktop\Files\Pishing-Detection\model_1.2\ValidationSet.csv", engine= 'python', quotechar='"') 
f1 = data['url']
f2 = data['status']
dataSize = len(f1)
...
def main():
    ...
    df.to_csv('model_1.2/Model_1.2DatasetValid.csv')
